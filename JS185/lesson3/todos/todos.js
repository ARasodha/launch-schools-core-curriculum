...
// const { persistence } = require("./lib/get-config"); // for potential config file set up
// const Persistence = require(persistence); // for potential config file set up
// const SessionPersistence = require("./lib/session-persistence"); // session persistence
...
//   res.locals.store = new Persistence(req.session); // for potential config file set up
//   next();
// });
